...
import { TAG_KEYS } from "../../utilities/constants"
...
export const RemoveComponent = (props: RemoveComponentProps) => {
    ...
    if (removeComponent) {
        ...
        return <Component data-testid="remove" onRemove={onRemove} onKeyDown={onKeydown} className={className} aria-label={ariaLabel} tag={tag} index={index} />
    }

    return (
        <button data-testid="remove" onClick={onRemove} onKeyDown={onKeydown} className={className} type="button" aria-label={ariaLabel}>
